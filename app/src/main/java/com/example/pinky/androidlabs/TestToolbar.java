...
public class TestToolbar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test__toobar);
    ...
    public boolean onOptionsItemSelected(MenuItem mi) {
        switch (mi.getItemId()) {
            ...
            case R.id.action_three:
                ...
                builder.setTitle("Snackbar Text Change");
            ...
            case R.id.action_four:
                Toast toast = Toast.makeText(this, "Version 1.0 by Priyanka Patel", Toast.LENGTH_SHORT);
                toast.show();
                break;
        }
